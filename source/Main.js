...
/**
 * Chama a animação Game Over e, em seguida, exclui os dados do jogo
 * @returns {Void}
 */
function gameOver() {
    display.set("ready");
...
/**
 * Cria o Blob e os Ghosts e inicia a animação Ready
...
/**
 * Chamado quando o Blob entra em um novo bloco
 * @returns {Void}
 */
function blobEating() {
...
/**
 * Chamado para fazer o crash entre um fantasma e o blob
 * @returns {Void}
 */
function ghostCrash() {
