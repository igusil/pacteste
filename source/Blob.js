...
export default class Blob {
    ...
    /**
     * Desenha um Blob com os dados fornecidos
     * @returns {Void}
     */
    draw() {
    ...
    /**
     * Salva a posição do Blob para excluí-lo e limpá-lo antes da próxima animação.
     * @returns {Void}
     */
    savePos() {
    ...
    /**
     * Desenha o próximo passo na animação de morte do Blob
    ...
    /**
     * Desenha um círculo como o próximo passo na animação Blob Death
     * @param {CanvasRenderingContext2D} ctx
     * @param {Number}                   count
     * @returns {Void}
     */
    ...
    /**
     * Retorna true se o Blob colidiu com uma parede
     * @returns {Boolean}
     */
    crashed() {
